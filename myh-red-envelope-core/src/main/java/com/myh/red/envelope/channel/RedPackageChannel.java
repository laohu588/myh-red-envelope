...
public class RedPackageChannel extends AbstractChannel {
    ...
    @Override
    public boolean addSmallHb(int ruleNo, String channelNumber, RedisTemplate redisTemplate, String bigHbId,
        List<String> smallHbs) {
        return ChannelExecuteUtils.addSmallHb(ruleNo, channelNumber, redisTemplate, bigHbId, smallHbs);
    }
